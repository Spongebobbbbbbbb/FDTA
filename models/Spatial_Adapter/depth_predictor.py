...
from .depth_encoder import TransformerEncoder, TransformerEncoderLayer
...
class DepthPredictor(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        """
        super().__init__()
        depth_num_bins = int(model_cfg.depth_bin_num)
    ...
    def forward(self, feature, mask, pos):
        ...
        depth_embed = self.depth_encoder(src.detach(), mask, pos)
